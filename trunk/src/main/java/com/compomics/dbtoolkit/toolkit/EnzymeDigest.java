...
/**
 * This class implements a command-line way of calling the sequence-based subset option with a
 * 'null' argument on the query in the ProcessThread class, albeit it is NOT called in threading mode.
 *
