...
/**
 * This class implements the test scenario for the SwissProtTaxonomyFilter class.
 *
...
public class TestSwissProtTaxonomyFilter extends TestCaseLM {
    ...
    public TestSwissProtTaxonomyFilter(String aName) {
        super(aName);
    }
    ...
    public void testFilter() {
        try {
            ...
            // Test case insensitivity at the same time.
            filter = new SwissProtTaxonomyFilter("Homo sapiens");
            ...
            fail("IOException was thrown while testing for filtering with SwissProtTaxonomyFilter: " + ioe.getMessage());
        }
    }
    ...
    public void testInvertedFilter() {
        try {
            ...
            db = DBLoaderFactory.getDBLoader(DBLoader.SWISSPROT);
            // Test case insensitivity at the same time.
            filter = new SwissProtTaxonomyFilter("Homo sapiens", true);
